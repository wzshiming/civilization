  ...
  return (
    <div className="app">
      ...
      {!worldMap ? (
        ...
        <>
          <ReadOnlyControlPanel isConnected={isConnected} onReconnect={handleReconnect} />
          ...
          <div className="map-controls-hint">
            <strong>💡 Tip:</strong> Use <strong>WASD</strong> or <strong>Arrow Keys</strong> to
            move the map, <strong>Mouse Wheel</strong> or <strong>+/-</strong> to zoom
          </div>
        </>
      )}
    </div>
