...
3. **Simulation**: Step through simulation with statistics
4. **History**: Undo/Redo operations with edit count
5. **Selection**: Select All/Clear with selection count
6. **Terrain Types**: Grid of terrain type buttons for painting
7. **Map Statistics**: Overview of terrain distribution
8. **Plot Properties**: Detailed view of selected plot (integrated PropertyPanel)
...
- **Buildings**: List of buildings on the plot (when present)
- **Species**: List of species on the plot (when present)
- **Populations**: List of population groups with counts (when present)
