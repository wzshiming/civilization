...
2. **Process Execution**: Execute all active processes in plots, buildings, and for species
...
1. **Process Execution Phase**: For each plot, execute terrain processes, building processes, and species processes
...
2. **Building Processes**: Production processes from buildings with workers
3. **Species Processes**: Consumption and production from species/populations
...
1. **Population Growth**: Species populations grow/shrink based on resources
2. **Building Construction**: Multi-step building construction
3. **Migration**: Species movement between plots
4. **Trade Routes**: Resource transfer between non-adjacent plots
5. **Events**: Random events that occur during steps
6. **Step Speed**: Variable step durations (hour, day, season, year)
