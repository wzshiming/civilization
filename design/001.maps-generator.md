...
ResourceEffect {
    ...
    monthlyConsumption: float   // Monthly consumption per capita
    monthlyProduction: float    // Monthly production per capita
}

DiffusionInfo {
    migrationRate: float        // Rate of migration to adjacent plots (0.0 to 1.0)
