...
ResourceEffect {
    ...
    monthlyConsumption: float   // Monthly consumption per capita (derived: dailyConsumption * 30)
    monthlyProduction: float    // Monthly production per capita (derived: dailyProduction * 30)
}

DiffusionInfo {
    migrationRate: float        // Percentage of population migrating per month (0.0 to 1.0)
